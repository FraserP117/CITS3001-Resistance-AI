...
class Game:
    ...
    def __init__(self, agents):
        ...
        '''
        Below is our attempt to play off one kind of agent with another.
        For some reason self.spy_probability in agent_SimpleBayes.py
        was never updatng when we ran this as opposed to the above.
        HIGHLY FRUSTRATING!
        '''
        # if len(agents)<5 or len(agents)>10:
        #     raise Exception('Agent array out of range')
